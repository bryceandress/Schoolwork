...
/*!
\mainpage This Example inputs a file name and demon strates how to store it using a subclass of an abstract base class that incorporates virtual functions to enable polymorphism. If a file name is input through the command line all of the options will be done automatically  
*/
#include <iostream>
#include <vector>
#include <fstream>
