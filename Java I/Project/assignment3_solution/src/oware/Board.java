...
public class Board implements Cloneable {
    ...
    @Override
    /**
     * Override the protected clone method and strengthen its accessibility
     */
    public Object clone() {
        Board board_clone = new Board();
        for (int i = 0; i < HOUSE_COUNT; i++) {
            board_clone.houses[i] = this.houses[i];
        }
        board_clone.northStore = this.northStore;
        board_clone.southStore = this.southStore;
        return board_clone;
    }
